...
# Bing 新闻检索词(每线口兜底)
QUERIES = {
    "AI/大模型": ["大模型 发布", "智能体 AI", "DeepSeek OR 通义 OR 智谱"],
    "机器人/AI硬件": ["人形机器人", "具身智能 融资", "AI眼镜"],
    "无人驾驶/低空/智慧出行": ["无人驾驶 Robotaxi", "低空经济 eVTOL", "网约车 监管"],
    "电商/直播/即时零售": ["直播电商", "外卖 即时零售", "跨境电商 Temu OR SHEIN"],
    "游戏/电竞/平台公司": ["游戏出海", "小游戏 版号", "电竞"],
    "消费/以旧换新/新餐饮": ["以旧换新 国补", "新茶饮 餐饮", "消费 广东"],
}
